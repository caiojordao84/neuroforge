  ...
  tokenize(): Token[] {
    ...
    while (this.cursor < this.src.length) {
      ...
      if (/[a-zA-Z_]/.test(char)) {
        ...
        const keywords = ['void', 'int', 'float', 'bool', 'String', 'File', 'if', 'else', 'while', 'for', 'return', 'true', 'false', 'HIGH', 'LOW', 'INPUT', 'OUTPUT', 'WL_CONNECTED', 'WL_IDLE_STATUS', 'FILE_WRITE', 'FILE_READ', 'FILE_APPEND'];
