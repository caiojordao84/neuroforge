...
use crate::types::asl_types::{
    ...
    AslAssign, AslDelay, AslDigitalOutput, AslExpr, AslExpressionStmt, AslFor, AslFunction, AslIf,

    AslMetadata, AslParam, AslPinMode, AslPrint, AslProgram, AslReturn, AslStatement, AslWhile,

    AslTask, AslLog, AslBinary, AslUnary, AslLiteral, AslDuration,

    PinModeKind, BinaryOp, UnaryOp,
...
impl NeuroParser for PythonParser {
    ...
    fn source_language() -> &'static str { "python" }
...
impl<'src> PythonVisitor<'src> {
    ...
    fn is_infinite_loop(&self, w: &AslWhile) -> bool {
        ...
        match &w.condition {
            ...
            AslExpr::Literal(l) => {
                ...
                l.value.as_bool() == Some(true) || l.value.as_i64() == Some(1)
    ...
    fn visit_call(&mut self, node: Node) -> AslStatement {
        ...
        match func_text.as_str() {
            ...
            "utime.sleep_ms" | "time.sleep_ms" | "sleep_ms" => AslStatement::Delay(AslDelay {
                ...
                duration: AslDuration::from_ms(args.first().and_then(|a| a.as_literal())
            ...
            "utime.sleep" | "time.sleep" | "sleep" => {
                ...
                AslStatement::Delay(AslDelay { duration: AslDuration::from_ms(ms.max(0) as u64) })
    ...
    fn visit_if(&mut self, node: Node) -> AslStatement {
        ...
        AslStatement::If(Box::new(AslIf {
            ...
            else_body: else_body, ..Default::default() }))
...
"#;
        ...
        assert!(loop_task.is_some(), "deve ter task loop a partir do while True em main via heur  stica");
