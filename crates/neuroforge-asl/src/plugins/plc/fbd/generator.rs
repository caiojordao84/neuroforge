                ...
                AslFunction {
                    ...
                    body: vec![
                        ...
                        AslStatement::Assign(AslAssign {
                            ...
                            value:  AslExpr::Var(AslVarRef { name: "SensorA".to_string() , ..Default::default() }),
                        ...
                        AslStatement::Assign(AslAssign {
                            ...
                            value: AslExpr::Call(Box::new(AslCall {
                                ...
                                args: vec![
                                    ...
                                    AslExpr::Var(AslVarRef { name: "A".to_string() , ..Default::default() }),

                                    AslExpr::Var(AslVarRef { name: "B".to_string() , ..Default::default() }),
                ...
                AslFunction {
                    ...
                    body: vec![
                        ...
                        AslStatement::TimerTon(AslTimerTon {
                            ...
                            r#in: AslExpr::Var(AslVarRef { name: "Start".to_string() , ..Default::default() }),

                            pt:   AslExpr::Var(AslVarRef { name: "Preset".to_string() , ..Default::default() }),
