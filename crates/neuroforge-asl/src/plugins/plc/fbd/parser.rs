...
//! Um body FBD    um grafo de n  s ligados por `connectionPointIn/connection/@refLocalId`.

//!

//! Tipos de n  s em `Body_FBD_Inline`:
...
//!   - `block`             fun    o/FB (typeName, instanceName, inputVariables, outputVariables)
...
//!   2. Para cada outVariable (e inOutVariable como sa  da):

//!      a. Seguir connectionPointIn     n   fonte.

//!      b. Resolver recursivamente a express  o ASL.
...
//!   4. Para outros blocos: AslExpr::Call gen  rico.
...
//!       .connection_point_out: Option<ConnectionPointOut>  (sem ref_local_id        fonte)
...
impl FbdParser {
    ...
    // Segue o grafo para tr  s a partir de um n   e constr  i a AslExpr:

    //   InVar            AslExpr::Var(expr)

    //   OutVar           AslExpr::Var(expression)   (passthrough)

    //   Block gen  rico     AslExpr::Call(type_name|instance, args)
