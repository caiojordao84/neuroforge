//! call_transform.rs     transforma chamadas de fun    o em n  s ASL de hardware
...
/// Resultado de transformar uma chamada de fun    o.
...
pub fn transform_call(call: &CallNode, ctx: &TransformContext) -> Option<AslStatement> {
    ...
    match call.name.as_str() {
        ...
        //        Chamada gen  rica (fun    o de utilizador)                                                                               
