//! API p  blica de transpila    o do crate neuroforge-asl.
...
/// O workflow passa sempre pela cria    o de uma AST unificada e omnidirecional (`AslProgram` - ASL JSON Tree).
...
/// - `"Linguagem desconhecida: ..."` se `lang` n  o for reconhecido.
