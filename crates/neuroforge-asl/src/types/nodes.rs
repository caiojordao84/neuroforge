...
//! Separados de asl_types para não misturar com a AST estruturada nova.
...
impl BaseNode {
    ...
    /// Nó folha sem filhos nem atributos.
    pub fn leaf(node_type: NodeType) -> Self {
        Self::new(node_type)
    }

    /// Nó de texto raw (para expressões não mapeadas).
    ...
    /// Nó de hardware com filhos (argumentos) e linha fonte.
...
impl ProgramNode {
    ...
    /// Os generators iteram `ast.children` onde cada filho é Function ou VarDeclaration.
