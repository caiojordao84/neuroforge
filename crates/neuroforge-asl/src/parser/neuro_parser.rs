...
// ============================================================================
// ParseError — Tipo de erro idiomático usando thiserror
// ============================================================================
...
pub trait NeuroParser: Sized {
    ...
    /// Ponto único de entrada para produzir um AslProgram canónico.
...
// ============================================================================
// NeuroParserExt — Validação semântica v1.2.3
// ============================================================================
...
pub trait NeuroParserExt: NeuroParser {
    fn validate_program(program: &AslProgram) -> Result<(), Vec<ParseDiagnostic>> {
        ...
        // Validação semântica da versão ASL
...
mod tests {
    ...
    fn test_r4_bool_like() {
        assert_eq!(bool_like("HIGH").unwrap().as_literal().unwrap().value, serde_json::json!(1));
        assert_eq!(bool_like("low").unwrap().as_literal().unwrap().value, serde_json::json!(0));
    }
    ...
    fn test_semver_validation() {
        ...
        let res = Dummy::validate_program(&program);
        assert!(res.is_err());
    }
}
